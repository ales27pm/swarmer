...
@pytest.mark.parametrize("skill", [None, *sorted(SUPPORTED_AGENT_SKILLS - SWIFT_SKILLS)])
...
def test_swift_arguments_remain_required_and_bounded(
...
def test_public_parser_still_rejects_non_swift_arguments(
